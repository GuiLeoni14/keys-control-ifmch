...
import { Clock, History, LogOut, Plus, RotateCcw, Unlock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="p-6 max-w-2xl mx-auto pb-32">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl blur-lg opacity-30">
          </div>
          <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-slate-700 shadow-xl">
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <h2 className="text-5xl font-black bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent mt-2">
                  0
                </h2>
              </div>
        ...
        {/* Quick Actions */}
        <div
          className="space-y-4 mb-8 animate-fadeInUp"
          style={{ animationDelay: "0.2s" }}
        >
          <h3 className="text-lg font-black text-gray-200 uppercase tracking-wider mb-4">
            Ações Rápidas
          </h3>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-green-600/0 via-green-600/10 to-green-600/0 group-hover:from-green-600/10 group-hover:via-green-600/20 group-hover:to-green-600/10 transition duration-500">
            </div>
            <div className="relative flex items-center gap-4">
              ...
              <div className="text-left flex-1">
                <h4 className="font-bold text-white group-hover:text-green-200 transition">
                  Retirar Chaves
                </h4>
              ...
              <div className="text-green-600 group-hover:text-green-400 transition transform group-hover:translate-x-1">
                →
              </div>
            </div>
          </button>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-red-600/0 via-red-600/10 to-red-600/0 group-hover:from-red-600/10 group-hover:via-red-600/20 group-hover:to-red-600/10 transition duration-500">
            </div>
            <div className="relative flex items-center gap-4">
              ...
              <div className="text-left flex-1">
                <h4 className="font-bold text-white group-hover:text-red-200 transition">
                  Devolver Chaves
                </h4>
                <p className="text-red-200/70 text-sm">Registrar devolução</p>
              </div>
              <div className="text-red-600 group-hover:text-red-400 transition transform group-hover:translate-x-1">
                →
              </div>
            </div>
          </button>
        ...
        {/* Info Card */}
        <div
          className="bg-gradient-to-br from-blue-600/20 to-cyan-600/20 border border-blue-600/50 rounded-2xl p-6 animate-fadeInUp"
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-blue-300/80 text-sm">
                Solicitações são processadas em tempo real pelo sistema Arduino.
                Aguarde a confirmação de desbloqueio.
              </p>
            </div>
          </div>
        </div>
